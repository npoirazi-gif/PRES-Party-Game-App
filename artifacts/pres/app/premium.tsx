  ...
  return (
    <LinearGradient colors={['#3611D2', '#140B4A']} style={styles.screen}>
      <ScrollView contentContainerStyle={[styles.content, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 30 }]}>
        ...
        <View style={styles.mark}><Feather name="star" size={26} color={c.text} /></View>
...
const styles = StyleSheet.create({
  ...
  title: { color: c.text, fontSize: 38, lineHeight: 44, fontWeight: '800', marginTop: 10 },
  ...
  featureText: { color: c.text, fontSize: 16, fontWeight: '700' },
  primary: { backgroundColor: c.accent, borderRadius: 16, alignItems: 'center', paddingVertical: 16, marginTop: 22 },
  primaryText: { color: c.text, fontSize: 14, fontWeight: '800', letterSpacing: 1 },
});