# Migrating web UI to PRES Design System

Read `artifacts/pres-design-system/docs/AGENTS.md` and
`artifacts/pres-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/pres-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/pres-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/pres-design-system/hooks/use-toast`
