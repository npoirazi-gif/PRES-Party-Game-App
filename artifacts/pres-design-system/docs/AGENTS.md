# PRES Design System design system
...
workspace package (`@workspace/pres-design-system`): other artifacts depend
...
`@workspace/pres-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/pres-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/pres-design-system` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/pres-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/pres-design-system/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/pres-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/pres-design-system/docs/migrating-expo.md`
