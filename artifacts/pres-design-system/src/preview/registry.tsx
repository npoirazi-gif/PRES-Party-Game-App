...
export const DESIGN_SYSTEM = {
  title: 'PRES Design System',
  description:
    'The visual language of the PRES party game — deep indigo surfaces, coral CTAs, violet actions, Inter type, and rounded sticker cards — built for UK university students on a night out.',
} as const;
