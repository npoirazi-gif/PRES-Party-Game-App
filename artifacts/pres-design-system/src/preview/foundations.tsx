...
const CORE_SWATCHES = [
  { name: 'Primary — Coral', className: 'bg-primary' },
  { name: 'Secondary — Violet', className: 'bg-secondary' },
  { name: 'Accent — Coral', className: 'bg-accent' },
] as const;
...
const TYPE_SCALE = [
  { label: 'Display', className: 'text-4xl font-black uppercase tracking-tight' },
  { label: 'Heading', className: 'text-2xl font-bold' },
